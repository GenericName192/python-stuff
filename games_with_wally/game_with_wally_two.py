...
class interface():
    ...
    def __init__(self, game: object, width: int, height: int, cell_size: int):
        ...
        self.boulder_tree_image = PhotoImage(file = "games_with_wally\images\\boulder_tree.png")
        self.boulder_image = PhotoImage(file = "games_with_wally\images\\boulders.png")
        self.grass_boulder_tree_image = PhotoImage(file = "games_with_wally\images\grass_boulder_tree.png")
        self.grass_image = PhotoImage(file = "games_with_wally\images\grass.png")
        self.tree_image = PhotoImage(file = "games_with_wally\images\\tree.png")
        self.water_image = PhotoImage(file = "games_with_wally\images\water.png")
        self.rock_image = PhotoImage(file = "games_with_wally\images\\rock_image.png")
        self.water_rock_image = PhotoImage(file = "games_with_wally\images\\rock_image_water.png")
        self.player_0 = PhotoImage(file = "games_with_wally\images\dude0.png")
        self.player_1 = PhotoImage(file = "games_with_wally\images\dude1.png")
        self.player_2 = PhotoImage(file = "games_with_wally\images\dude2.png")
        self.player_3 = PhotoImage(file = "games_with_wally\images\dude3.png")
        self.player_0_rock = PhotoImage(file = "games_with_wally\images\dude_rock_0.png")
